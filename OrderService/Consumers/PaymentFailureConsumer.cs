...
public class PaymentFailureConsumer : IConsumer<PaymentFailedEvent>
{
    private readonly OrderDbContext _dbContext;
    private readonly ILogger<PaymentFailureConsumer> _logger;

    public PaymentFailureConsumer(OrderDbContext dbContext, ILogger<PaymentFailureConsumer> logger)
    {
    ...
    {
        _logger.LogInformation($"[{DateTime.Now:HH:mm:ss}] Processing PaymentFailedEvent for OrderId: {context.Message.OrderId}");
